            ...
            <section id="main">
                <div class="game">
                    ...
                    <div class="description">
                        <p>Counter-Strike: Global Offensive (CS: GO) expands upon the team-based action from 14 years ago. It features new maps, weapons, and delivers updated versions of the classic CS content.</p>
                    </div>
                    <div class="img1">
                ...
                <div class="game">
                    ...
                    <button>Launch</button>
                    <div class="description">
                        <p>League of Legends is a fast-paced, competitive online game that blends the speed and intensity of an RTS with RPG elements. Two teams  battle across multiple battlefields and game modes. </p>
                    </div>
                    <div class="img1">
                ...
                <div class="game">
                        ...
                        <button>Launch</button>
                        <div class="description">
                            <p>When it comes to diversity of heroes and abilities, Dota's roster is unmatched. With regular updates that evolve its gameplay, features, and heroes, Dota 2 has truly taken on a life of its own.
                            </p>
                        </div>
                ...
                <div class="game">
                        ...
                        <button>Launch</button>
                        <div class="description">
                            <p>Fortnite Battle Royale is a FREE 100-player PvP arena. One giant map. A battle bus. Fortnite building skills and destructible environments combined with intense PvP combat. </p>
                        </div>
