...
<body>
    ...
    <div id="links">
        <h2>Links</h2> 
        <div id="socials">
            <img class="social-img" src="socialmedia/Facebook.png">
            <img class="social-img" src="socialmedia/Twitter.png">
            <img class="social-img" src="socialmedia/Reddit.png">
            <img class="social-img" src="socialmedia/Linkedin.png">
            </div>
        <div id="logo">
    ...
    <div id="media">
        ...
        <div id="gamelist">
           <p>Gamelist</p>
            ...
            <div class="game-img" id="game1">
            <img src="csgoBanner.jpg" style="width: 405; height: 76;">
            </div>
            
            <div class="game-img" id="game2">
            <img src="leagueBanner.jpg" style="width: 405; height: 76;">
            </div>
            
            <div class="game-img" id="game3">
            <img src="dotaBanner.jpg" style="width: 405; height: 76;">
            </div>
            
            <div class="game-img" id="game4">
            <img src="fortniteBanner.jpg" style="width: 405; height: 76;">
            </div>
            
            <div class="game-img" id="game5">
            <img src="minesweepBanner.png" style="width: 405; height: 76;">
            </div>
        
        </div>
    </div>
    <div id="footer">
        <p>&copy; Gameframe 2018. All Rights Reserved.</p>
